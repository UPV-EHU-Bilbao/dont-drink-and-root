...
public class UniqueFollowerController extends ListCell<Account>{
    ...
    protected void updateItem(Account item, boolean empty) {
        ...
        if (fxmlLoader == null) {
            fxmlLoader = new FXMLLoader(getClass().getResource("/eus/ehu/bum4_restapi/user-uniquefollower.fxml"));
